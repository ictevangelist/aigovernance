...
home_body = f"""<section class="hero">
  <div class="container">
    ...
    <p class="lede">This is a plain-English companion to the <strong>Use of Artificial Intelligence (AI) Policy</strong> template. It sets out what you need to decide, why each decision matters, and the law and guidance behind it. Written for adoption from <strong>September 2026</strong>.</p>
    <div class="btn-row">
...
<section class="section"><div class="container">
  <p class="lead section-intro">AI is already in your classrooms and your offices: inside the everyday software your staff use, and a browser tab away for anyone who wants it. Governing it well is not about slowing that down. It is about making sure your use of it is <strong>safe, lawful and defensible</strong>, so you get the benefits without putting at risk the safety of children and adults, the privacy of their data, fairness, or professional integrity.</p>

  <h2 class="mt-0" style="margin-top:2rem;">Start wherever suits you</h2>
  <div class="card-grid" style="margin-top:1.2rem;">
    <a class="card card--link" href="landscape.html"><h3>The landscape</h3><p>Why you need a policy now, what counts as “AI”, and the law and guidance that applies to you.<span class="more">Read &rsaquo;</span></p></a>
    <a class="card card--link" href="approval-gate.html"><h3>The approval gate</h3><p>The heart of the policy: how a tool becomes approved, and why “not approved” is the starting point.<span class="more">Read &rsaquo;</span></p></a>
    <a class="card card--link" href="data-protection.html"><h3>Data protection</h3><p>The rule on personal data, your lawful basis, controllers and processors, and how long data is kept.<span class="more">Read &rsaquo;</span></p></a>
    <a class="card card--link" href="impact-assessment.html"><h3>Impact assessment</h3><p>When you need a DPIA, what a product-safety check covers, and a free tool to get you started.<span class="more">Read &rsaquo;</span></p></a>
    <a class="card card--link" href="safeguarding.html"><h3>Safeguarding &amp; Prevent</h3><p>Deepfakes, online-safety duties, and how an AI concern reaches your designated safeguarding lead.<span class="more">Read &rsaquo;</span></p></a>
    <a class="card card--link" href="pupil-use.html"><h3>Pupil use</h3><p>The optional module, and the two conditions to meet before pupils use AI at all.<span class="more">Read &rsaquo;</span></p></a>
  </div>

  <h2>The non-negotiables</h2>
  <p>Most of the template is yours to shape. Five things are not. Weaken any of them and the policy stops being defensible:</p>
  <div class="card-grid">
    <div class="card"><h3>No personal data in</h3><p>Personal or special-category data does not go into AI tools. The only exception is a tool that has been approved, through the gate, for that specific purpose.</p></div>
    <div class="card"><h3>A person always decides</h3><p>AI never makes a decision about a person. A named member of staff makes, and owns, any decision that affects someone.</p></div>
    <div class="card"><h3>A DPIA before you deploy</h3><p>You complete a data protection impact assessment before deploying AI that processes personal data, and early enough to shape the decision.</p></div>
    <div class="card"><h3>The approval gate</h3><p>Approved tools only, through organisation accounts. Anything else, including public chatbots on a personal login, is not approved.</p></div>
    <div class="card"><h3>Safeguarding duties hold</h3><p>Your Prevent, safeguarding and online-safety duties apply to AI-assisted work exactly as they do to everything else.</p></div>
  </div>

  <h2>Two things to take away</h2>
  <div class="card-grid">
    <a class="card card--link" href="policy-template.html"><h3>The policy template &darr;</h3><p>A completable <em>Use of AI Policy</em> for schools, trusts and colleges: a staff-use core, with optional modules for pupil use and governed exceptions.<span class="more">Download &rsaquo;</span></p></a>
    <a class="card card--link" href="dpia-tool.html"><h3>The DPIA screening tool &darr;</h3><p>A plain-English tool that runs in your browser, for any AI or digital product you are thinking of buying. Complete it, save it, send it to your DPO.<span class="more">Unlock &rsaquo;</span></p></a>
  </div>

  <h2>Your questions, answered</h2>
  <div class="faq">
    <details><summary>Does every school need its own AI policy?</summary><div class="faq__a"><p>You need a position that is yours, and that your stakeholders have agreed. If you are a multi-academy trust, adopt one policy centrally and hold school-level detail in local appendices, rather than running separate versions. The template is written to be completed for your setting, not used as it stands.</p></div></details>
    ...
    <details><summary>Can staff just use ChatGPT for work?</summary><div class="faq__a"><p>Only if it has been approved through the gate, and only through an organisation-provided account. Personal accounts are not used for work, and public consumer chatbots are not approved by default.</p></div></details>
    <details><summary>When do we need a DPIA?</summary><div class="faq__a"><p>Before you deploy AI that processes personal data, and wherever a tool is likely to create a high risk to people. Doing it early, before the decision is made, is what the DfE guidance expects. The <a href="dpia-tool.html">screening tool</a> helps you judge whether you are ready.</p></div></details>
  </div>
</div></section>"""
...
home_ld = {
    ...
    "mainEntity": [
        {"@type": "Question", "name": "Does every school need its own AI policy?",
         "acceptedAnswer": {"@type": "Answer", "text": "You need a position that is yours and that your stakeholders have agreed. If you are a multi-academy trust, adopt one policy centrally and hold school-level detail in local appendices. The template is completed for your setting, not used as it stands."}},
        ...
        {"@type": "Question", "name": "Can staff just use ChatGPT for work?",
         "acceptedAnswer": {"@type": "Answer", "text": "Only if it has been approved through the gate and used through an organisation-provided account. Personal accounts are not used for work, and public consumer chatbots are not approved by default."}},
...
PAGES.append(("landscape.html", "The landscape", "Sections 1–2 of the template",
  ...
  "Before any rule: why you would govern AI at all, what counts as “AI” here, and the law and guidance the policy sits within.",
  f"""
  <p class="lead">A good AI policy starts with your reasons for using AI in the first place: what it is there to help with in your setting, whether that is teaching, workload or inclusion. Set that out before any rule appears. The governance is there to serve that purpose, not to get in its way.</p>
  ...
  <p>AI rarely arrives through one obvious route. It turns up inside the platforms you already license, and behind any browser tab a member of staff cares to open. A policy written only around “the AI tool we bought” will miss most of your real exposure. Defining scope by what a tool does, namely whether it generates content or makes or informs decisions about people, is what keeps your policy relevant as products change around you.</p>
  <p>If you are a multi-academy trust, adopt one policy centrally and hold school-level detail in local appendices. Separate versions drift apart over time and become very hard to assure.</p>

  {keypoints("What you decide here", [
    "Your reasons for adopting AI: a sentence or two on what it is there to help with in your setting.",
    ...
    "Whether pupils are in scope. They are not, by default, until the optional module’s conditions are met.",
  ])}
...
PAGES.append(("roles.html", "Roles & oversight", "Section 3 of the template",
  ...
  <h2>What it is</h2>
  <p>A list of roles and what each one owns. Delete the roles you do not have, merge them where one person carries several, and reassign anything left over to whoever will pick it up. The usual owners are:</p>
  <ul>
  ...
  <h2>Why it matters</h2>
  <p>The DfE governance standards expect clear lines of accountability, and the ICO’s edtech audits found, again and again, responsibilities that everyone assumed somebody else was holding. Putting a name against each line is what lets you assure it properly, and report on it to your board.</p>
...
PAGES.append(("approval-gate.html", "The approval gate", "Sections 4 &amp; 4a of the template",
  ...
  f"""
  <p class="lead">Staff may use AI for work only through tools your organisation has approved, and only through organisation-provided accounts. Everything else is off-limits by default. That starting point is deliberate, and it does a great deal of the work.</p>

  <h2>What it is</h2>
  <p>A single, clear gate that every tool passes through before it is used for work. The approved list names each tool and what it is approved <em>for</em>. Anything not on that list, including public consumer chatbots and anything reached through a personal login, is not approved and is not used. One point catches people out: <strong>a new AI feature that appears inside a product you already approve is not approved by default</strong>. It goes back through the gate before anyone uses it.</p>
  ...
  <h2>Why it matters</h2>
  <p>The gate is what makes the rest of the policy enforceable. Without it, rules like “no personal data into AI” or “a DPIA before deployment” have nothing to attach to. With it, the questions that matter — what data the tool uses, your lawful basis for it, and what the supplier does with it — are answered before the tool is in daily use, rather than discovered afterwards. This is exactly what the DfE product safety standards and the ICO’s audit findings both point to: assess before you adopt.</p>

  {nonneg("The approval gate is a non-negotiable, and so is the rule that a new AI feature inside an existing product comes back through it. “We already use this supplier” is not the same as approval.")}
...
PAGES.append(("acceptable-use.html", "Acceptable use", "Sections 5 &amp; 6 of the template",
  ...
  <p>Set out the low-risk, genuinely helpful uses you want to encourage: drafting and adapting resources, summarising, planning, routine administrative writing. Always through approved tools and organisation accounts, and always with a person checking the output before it is used. What you are giving is permission, exercised with professional judgement.</p>
  ...
  <ul>
    ...
    <li>Enter personal or special-category data, meaning information about real, identifiable people, into an AI tool, unless it has been approved for that specific purpose.</li>
    <li>Let AI make a decision about a person. In sensitive areas, even assistive use is prohibited unless it has been expressly authorised, with a named person making and owning the decision.</li>
  ...
  <h2>Why it matters</h2>
  <p>By far the most common way personal data ends up in an AI tool is not a technical breach. It is a member of staff pasting a name, a report or a case note into a chatbot to save a little time. That is why the rule on what goes in is the one boundary you should not soften locally. The high-risk prohibitions are there because these are the decisions where an automated shortcut does the most damage.</p>

  {nonneg("The rule against entering personal or special-category data into AI tools, and the principle that a person always decides, are non-negotiable. Tailor the examples around them; do not remove the substance.")}
...
PAGES.append(("data-protection.html", "Data protection", "Section 7 of the template",
  ...
  f"""
  <p class="lead">Data protection is where most of the risk in AI-for-education sits. Get four things clear — who the data is about, your lawful basis, the supplier’s role, and how long data is kept — and most of the rest follows.</p>
  ...
  <h2>Why it matters</h2>
  <p><strong>Controller or processor is the sector’s most common failing.</strong> Normally your school or trust decides why and how data is used (the controller) and the supplier only acts on your instructions (the processor). But the label in the contract does not settle it; what the supplier actually does settles it. If a supplier uses the data for its own purposes, such as product development, analytics or improving its AI, it is acting as a controller for that use, extra rules apply (including the Children’s Code where pupils are involved), and you should ask why it needs to do this at all.</p>
  <p><strong>Your lawful basis is rarely consent.</strong> For most of what a school does, the basis is public task: part of running the school and educating pupils. Do not confuse a tool’s terms requiring parent or guardian agreement with your lawful basis. They are two different things.</p>
  <p><strong>Free text is easy to overlook.</strong> A tool that only asks for a name and email can still process sensitive information the moment someone types into a free-text box. It is the rule on what staff may enter, not the sign-up form, that protects you.</p>
  ...
  {nonneg("A DPIA is completed before you deploy AI that processes personal data. It is not a form you complete afterwards; it is how you make the decision.")}
...
PAGES.append(("accuracy-oversight.html", "Accuracy & oversight", "Section 8 of the template",
  ...
  f"""
  <p class="lead">Generative AI produces fluent, plausible text, and it is wrong often enough that nothing should go out on its say-so. Treat what it produces as a first draft that a professional checks, corrects and takes responsibility for.</p>
  ...
  <h2>Why it matters</h2>
  <p>“Meaningful human involvement” is a legal test, not a form of words. If a member of staff genuinely reads what a tool suggests and is free to change it, then it is the member of staff who is deciding, and that is fine. If the output is waved through unread, it is really the tool deciding, and that is where the law and plain fairness come in. The Equality Act and the public sector equality duty apply to AI-assisted work just as they do to everything else, so bias that would be unlawful coming from a person is no more acceptable coming from a model.</p>
...
PAGES.append(("safeguarding.html", "Safeguarding & Prevent", "Section 9 of the template",
  ...
  <p><strong>Fabricated media and deepfakes.</strong> Creating or sharing fabricated media intended to mislead, harass, distress or harm anyone in the community is prohibited. Where such material is sexual it may be criminal, and <strong>AI-generated sexual imagery of a child is a criminal matter in every circumstance</strong>. It is reported to the designated safeguarding lead, handled under the child protection policy, and referred to the police where required, in line with the Online Safety Act 2023 and the Ofcom Protection of Children code. Multi-agency action follows Working Together to Safeguard Children 2026.</p>

  <h2>Why it matters</h2>
  <p>The tools to fabricate convincing images, audio and video are now widely available and simple to use. The schools left scrambling when this arrives are the ones that never named the risk in their policy. Making the reporting route explicit, and the same one staff already use, means an AI-enabled incident is dealt with as quickly, and as seriously, as any other.</p>
...
PAGES.append(("impact-assessment.html", "Impact assessment", "Section 10 of the template",
  ...
  f"""
  <p class="lead">A DPIA, or Data Protection Impact Assessment, is simply the structured assessment the law requires whenever a tool is likely to create a high risk to people. Carried out early, before decisions are made, it is exactly what the DfE guidance expects.</p>
  ...
  <h2>Why it matters</h2>
  <p>A DPIA completed after a tool is already embedded changes very little; the decisions have been made. Completed early, it does real work. It brings the controller and processor question, international transfers, retention, sub-processors, and any training on your data into view before you are committed. A tool that lacks a particular compliance feature is not ruled out automatically. What matters is whether you can put sensible operational safeguards around it, and record them.</p>

  <div class="commentary" style="border-left-color:#0ea3ab;">
    <h3>Get the screening tool</h3>
    <p>The <a href="dpia-tool.html">AI &amp; Digital Tool DPIA Screening Tool</a> is a plain-English questionnaire that runs in your browser, for any AI or digital product you are thinking of buying. It works through purpose, data, roles, transfers, retention, automated decisions and what the supplier does with the data, then tells you whether your answers are detailed enough to send to your DPO for sign-off. Unlock a copy to keep and reuse.</p>
  </div>

  {nonneg("A DPIA before you deploy AI that processes personal data is a non-negotiable. The screening tool supports that assessment; it does not replace your DPO’s sign-off.")}
...
PAGES.append(("training.html", "Training", "Section 11 of the template",
  ...
  f"""
  <p class="lead">Staff follow rules they understand, and work around rules they do not. Training is what takes the policy off the page and into everyday practice.</p>
...
PAGES.append(("filtering-monitoring.html", "Filtering & monitoring", "Section 12 of the template",
  ...
  f"""
  <p class="lead">The policy sets the rules; filtering and monitoring are what enforce them. This section names who owns those arrangements, and how assurance reaches your leadership.</p>
  ...
  <h2>Why it matters</h2>
  <p>An approval gate with nothing behind it is little more than a request. Blocking unapproved AI services, and monitoring in line with your existing duties, is what stops unofficial use gradually becoming the norm. The DfE standards expect a senior named owner, rather than a shared inbox, so that filtering and monitoring is somebody’s clear responsibility, reviewed and reported, rather than an assumption.</p>
...
PAGES.append(("breaches.html", "Breaches", "Section 13 of the template",
  ...
  f"""
  <p class="lead">Every policy needs a clear answer to one question: what happens if this is broken? Setting the routes out in advance is what lets you respond calmly and consistently when you are under pressure.</p>
  ...
  <h2>Why it matters</h2>
  <p>Personal-data breaches carry statutory reporting deadlines, and safeguarding incidents carry duties of their own. Deciding the routes now — who is told, in what order, and within what time — means a stressful event is handled as a process you already have, rather than one you invent on the day. It also makes clear to staff that the rules are real, which is a deterrent in itself.</p>
...
PAGES.append(("guidance-map.html", "The guidance map", "Reference",
  ...
  f"""
  <p class="lead">The <em>Use of AI Policy</em> does not stand on its own. It sits within a body of law, statutory guidance and sector standards. This page maps the whole of it in one place.</p>
  ...
  <p class="chart-note">Frameworks and their commencement dates change. Confirm the current version of each one before you rely on it, and take your own professional or legal advice where there is any doubt. This map is a signpost, not a statement of the law.</p>
  """,
