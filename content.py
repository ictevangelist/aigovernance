...
home_body = f"""<section class="hero">
  <div class="container">
    ...
    <h1>Get <span class="accent">AI governance</span> right in your school or trust.</h1>
    <p class="lede">I’ve put this site together as a plain-English companion to my <strong class="accent">Use of Artificial Intelligence (AI) Policy</strong> template. It walks you through what you’ll need to decide, why each decision matters, and the law and guidance that sits behind it all. Written for adoption from <strong>September 2026</strong>.</p>
    <div class="btn-row">
...
PAGES.append(("data-protection.html", "Data protection", "Section 7 of the template",
  ...
  f"""
  <p class="lead">Data protection is where most of the risk in AI-for-education sits. Get four things clear: whose data it is, your lawful basis, the supplier’s role, and how long data is kept. Most of the rest follows.</p>
...
LEGAL = [
 ...
 (link("Sexual Offences Act 2003", "https://www.legislation.gov.uk/ukpga/2003/42/contents"),
  "The intimate image offences, which from 6 February 2026 include creating, or requesting the creation of, purported intimate images."),
...
ACCENT = {
    'landscape.html':           'why govern AI, and what applies to you',
    'roles.html':               'responsibilities &amp; oversight',
    'approved-tools.html':      'how tools are approved',
    'acceptable-use.html':      'what staff may and must not do',
    'data-protection.html':     '&amp; information security',
    'accuracy-oversight.html':  'accountability &amp; human oversight',
    'safeguarding.html':        'online safety &amp; Prevent',
    'impact-assessment.html':   '&amp; product safety checks',
    'training.html':            '&amp; awareness',
    'filtering-monitoring.html':'monitoring &amp; assurance',
    'breaches.html':            'serious incidents',
    'pupil-use.html':           'use of AI',
